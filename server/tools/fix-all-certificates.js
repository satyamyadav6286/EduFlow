...
// Create empty certificate PDF files for all certificates in the database
async function ensureAllCertificates() {
  try {
    ...
    console.log(`- Created ${createdCount} new certificate placeholder files`);
    console.log(`- Found ${existingCount} existing certificate files`);
